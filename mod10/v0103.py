...
class House:
    ...
    def fire_alarm(self):
        print("\n*** FIRE ALARM! All elevators are going to the ground floor! ***")
        for i, elevator in enumerate(self.elevators):
            print(f"Elevator {i + 1} is heading to the ground floor...")
            elevator.move_to_floor(self.lowest_floor)

if __name__ == "__main__":
    house = House(lowest_floor=1, highest_floor=10, number_of_elevators=3)  # Create a house with 3 elevators
